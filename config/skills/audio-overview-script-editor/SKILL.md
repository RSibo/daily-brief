...
| **Target Runtime** | 6 to 15 minutes (~800–2,400 spoken words at 1.05x speed), depending on content depth and impact. |
...
2. Open the script with the mandatory phrase: "Let's begin; " followed immediately by the first operational signal. Cut all introductory pleasantries (*"Good evening"*, *"Today is Monday"*, *"Welcome to"*).
...
5. Target runtime is 6 to 15 minutes (~800 to 2,400 words) depending on content depth. Expand updates with full operational implications.
...
| **Word Limit** | Total script word count supports 6–15 min runtime (~800 to 2,400 words). | [ ] |
| **Mandatory Opening Hook** | Starts with *"Let's begin; "* with zero greeting pleasantries (*"Good morning"*). | [ ] |
...
```text
Let's begin; top of mind for decisions tonight is the staffing sign-off for the Woolworths deployment. Nicole flagged that without backend approval by nine tomorrow morning, the staging window slips by forty-eight hours. 
